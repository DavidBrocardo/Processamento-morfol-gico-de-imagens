...
def main(): 
    ...
    img_fechamento= Erosao(Dilatacao(img_binaria, elemento_Estruturante), elemento_Estruturante)
    img_fechamento_np = np.array(img_fechamento, dtype=np.uint8)
    cv2.imwrite("img_fechamento.png", img_fechamento_np)
